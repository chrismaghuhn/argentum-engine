...
/** Test-only evidence for the copy-specific SpellFizzledEvent lifecycle. */
class SpellFizzledEmitterAuthorityCharacterizationTest : FunSpec({
    test("a copied spell fizzles from its pre-event stack object without a ZoneChangeEvent") {
        ...
        result.state.objectIdentityStamps[copyId] shouldBe 101L
    }
})
