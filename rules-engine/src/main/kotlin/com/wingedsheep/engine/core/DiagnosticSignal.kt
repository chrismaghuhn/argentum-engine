...
enum class DiagnosticCode(val kind: DiagnosticKind) {
    ...
    STRUCTURED_DOMAIN_UNSUPPORTED(DiagnosticKind.UNSUPPORTED_DECISION),
    ...
    ACTION_TARGET_DOMAIN_UNSUPPORTED(DiagnosticKind.UNSUPPORTED_DECISION),
    ATTACK_DECLARATION_DOMAIN_UNSUPPORTED(DiagnosticKind.UNSUPPORTED_DECISION),
    BLOCKER_DECLARATION_DOMAIN_UNSUPPORTED(DiagnosticKind.UNSUPPORTED_DECISION),
