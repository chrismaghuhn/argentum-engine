...
val engineSerializersModule = SerializersModule {
    ...
    polymorphic(ContinuationFrame::class) {
        ...
        subclass(SpellResolutionContinuation::class)
        ...
        subclass(CascadeAfterBottomContinuation::class)
        subclass(ExileFromTopRepeatingContinuation::class)
        subclass(DiscoverMayCastContinuation::class)
        subclass(DiscoverAfterBottomContinuation::class)
        subclass(DiscoverNoHitBottomContinuation::class)
    ...
    polymorphic(Component::class) {
        ...
        subclass(FirstCombatDamageStepEligibilityComponent::class)
