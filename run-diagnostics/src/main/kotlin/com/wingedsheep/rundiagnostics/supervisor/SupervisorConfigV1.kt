...
@Serializable
public data class DiagnosticBundleConfigurationV1(
    ...
    public val safeArtifactPathCount: Int = 0,
    ...
    public val jvmToolDirectoryConfigured: Boolean = false,
    ...
    init {
        ...
        require(safeArtifactPathCount in 0..128) { "safeArtifactPathCount is outside the bounded range" }
...
public data class SupervisorConfigV1(
    ...
    public fun bundleConfiguration(): DiagnosticBundleConfigurationV1 = DiagnosticBundleConfigurationV1(
        heartbeatTimeoutMillis = heartbeatTimeoutMillis,
        usefulProgressTimeoutMillis = usefulProgressTimeoutMillis,
        sampleIntervalMillis = sampleIntervalMillis,
        diagnosticCaptureCooldownMillis = diagnosticCaptureCooldownMillis,
        maxDiagnosticBundles = maxDiagnosticBundles,
        maxHistorySamples = maxHistorySamples,
        threadDumpCount = threadDumpCount,
        threadDumpIntervalMillis = threadDumpIntervalMillis,
        captureTimeoutMillis = captureTimeoutMillis,
        maxCommandOutputBytes = maxCommandOutputBytes,
        maxBundleBytes = maxBundleBytes,
        safeArtifactPathCount = safeArtifactPaths.size,
        cpuActiveFraction = cpuActiveFraction,
        cpuLowFraction = cpuLowFraction,
        processStartToleranceMillis = processStartToleranceMillis,
        jvmToolDirectoryConfigured = jvmToolDirectory != null,
        once = once,
    )
}
