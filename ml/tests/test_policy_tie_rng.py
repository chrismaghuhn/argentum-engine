...
class PolicyTieRngTests(unittest.TestCase):
    def test_stream_and_raw_word_kats(self) -> None:
        state = PolicyTieRngStateV1.from_policy_seed(4259905, 0)
        ...
        seat_one = PolicyTieRngStateV1.from_policy_seed(4259905, 1)
