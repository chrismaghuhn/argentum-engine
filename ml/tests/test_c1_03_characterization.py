...
class C1_03CharacterizationTests(unittest.TestCase):
    ...
    def test_report_is_deterministic_identity_bound_and_path_free(self):
        ...
        self.assertIn("ACCEPTED_PRODUCER_FIX_MAIN=", first)
        self.assertIn("REVIEWED_PLAN_HEAD=", first)
        self.assertIn("PLAN_DIGEST=", first)
        self.assertIn("STRICT_PYTHON_READER=", first)
        self.assertIn("GAMEPLAY_BLOCK_REASON=", first)
        self.assertIn("C1_04_AUTHORIZED=NO", first)
