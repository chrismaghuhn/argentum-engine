...
val CommandersSphere = card("Commander's Sphere") {
    ...
    metadata {
        ...
        ruling("2020-11-10", "If your commander is a card that has no colors in its color identity, this ability produces no mana. It doesn't produce {C}.")
        ruling("2020-11-10", "If you have two commanders, the ability adds one mana of any color in their combined color identities.")
        ruling("2020-11-10", "If you don't have a commander, this ability produces no mana.")
    }
}
